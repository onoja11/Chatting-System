<div
    x-data="{
        ...
        init() {
            ...
            this.scrollToBottom();
            // Watch for changes in the loadedMessages and scroll to the bottom
       ...
       " --}}
        ...
        <footer class="shrink-0 z-10 bg-white inset-x-0">
            <div class="p-2 border-t">
                <form x-data="{ body: @entangle('body') }"  @submit.prevent="$wire.sendMessage().then(() => { body = '' })" method="POST" autocapitalize="off">
                    @csrf
