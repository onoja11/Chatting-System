<div x-data="{ type: 'all', query: @entangle('query') }"
     x-init="
        setTimeout(() => {
            let conversationElement = document.getElementById('conversation-' + query);
                ...
                <aside class="grid grid-cols-12 w-full">
                    ...
                    <div class="col-span-1 flex flex-col text-center my-auto">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <button class="flex items-center gap-3 w-full px-4 py-2 text-sm leading-5 text-gray-500 hover:bg-gray-100 focus:bg-gray-100">
                                    <span>
