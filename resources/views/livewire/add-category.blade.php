    ...
    <x-modal name="add-category" focusable>
        <form class="p-6">
            ...
            <div class="mt-6 flex justify-end">
                ...
                <x-success-button class="ms-3 bg-indigo-700 hover:bg-indigo-600 focus:bg-indigo-800 active:bg-indigo-700 dark:focus:ring-indigo-500" wire:click.prevent="createCategory">
                    Save
