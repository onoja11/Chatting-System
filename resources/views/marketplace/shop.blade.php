        ...
        <div class="w-full border-l h-full relative overflow-y-auto" style="contain: content">
            <div class="m-auto text-center justify-content flex flex-col gap-3">
                ...
                <header class="px-3 z-10 bg-white sticky top-0 w-full py-2">
                 ...
                 <div class="flex overflow-x-auto gap-2 py-3 px-4 border-b bg-gray-100">
                                ...
                                <div class="border rounded-lg p-4 shado hover:shadow-lg">
                                    ...
                                    <div class="flex justify-around mt-4">
                                        ...
                                        <form action="{{ route('stripe') }}" method="post">
                                            ...
                                            <x-secondary-button type="submit" class="hover:shadow-lg">
                                                <i class="fas fa-money-bill-wave pr-2"></i> Buy</x-secondary-button>
                                        </form>
                                        <a href="{{route('watch')}}" class="">
                                            <x-primary-button>
                                                <i class="fas fa-video pr-2"></i>Watch Ads</x-primary-button>
                                        </a>
                                    </div>
                                </div>
                            @empty
                            <div class=" md:w-[800px] mt-10    ">
                                <img src="{{ asset('images/Empty.gif') }}" alt="" width="200" height=""
                                    class="m-auto">
